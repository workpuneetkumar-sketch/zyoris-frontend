...
export default function MessagesPage() {
    ...
    return (
        <div className="flex h-[calc(100vh-theme(spacing.16))] p-0 md:p-4 lg:p-8 bg-gray-50">
            <div className="w-full max-w-6xl mx-auto flex bg-white backdrop-blur-xl md:rounded-[2rem] shadow-xl shadow-gray-200/60 border border-gray-100 overflow-hidden">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-2">
                        {error ? (
                            ...
                            <div className="flex flex-col items-center justify-center h-full p-6 text-center text-gray-500">
                                ...
                                <p className="text-sm font-bold text-gray-700">No chats available</p>
                            ...
                            <div 
                                ...
                                className={`flex items-center gap-4 p-3.5 rounded-2xl cursor-pointer transition-all duration-200 border ${
                                    activeSession?.id === session.id 
                                        ? "bg-blue-50 border-blue-100 shadow-sm shadow-blue-100/60"
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className={`text-xs truncate font-medium ${activeSession?.id === session.id ? "text-blue-600" : "text-gray-500"}`}>
                ...
                <div className={`flex-1 flex flex-col min-w-0 bg-gray-50 ${!showMobileChat ? 'hidden md:flex' : 'flex'}`}>
                    {activeSession ? (
                        <>
                            {/* Chat Header */}
                            <div className="flex items-center p-4 md:p-6 border-b border-gray-100 bg-white shrink-0">
                                <button onClick={() => setShowMobileChat(false)} className="md:hidden p-2 mr-3 -ml-2 rounded-xl hover:bg-gray-100 text-gray-500 transition-all">
                                    <ChevronLeft size={20} />
                                </button>
                                                ...
                                                <div key={msg.id || idx} className={`flex flex-col ${isMe ? "items-end" : "items-start"} group`}>
                                                    ...
                                                    <div className={`max-w-[85%] md:max-w-[70%] px-5 py-3.5 text-[15px] leading-relaxed shadow-sm transition-all hover:shadow-md ${
                                                        isMe 
                                                            ...
                                                            : "bg-white border border-gray-200 text-gray-700 rounded-[1.5rem] rounded-tl-sm"
                                                    } break-words`}>
                                                        {isEditing ? (
                                                            <textarea
                                                                value={editText}
                            ...
                            <div className="p-4 md:p-6 bg-white border-t border-gray-100 shrink-0">
                                <form onSubmit={handleSend} className="max-w-4xl mx-auto flex items-end gap-3">
                                    <div className="flex-1 bg-gray-50 rounded-3xl p-1.5 flex items-center shadow-sm border border-gray-200 focus-within:border-blue-600 focus-within:ring-4 focus-within:ring-blue-100 transition-all">
                                        <input 
                                            type="text" 
                                            value={inputText}
