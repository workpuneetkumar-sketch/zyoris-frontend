export default function DashboardLoading() {
  return (
    <div className="min-h-screen bg-[#f5f7fb] flex">
      {/* Sidebar Skeleton */}
      <aside className="w-[330px] bg-white border-r border-gray-200 flex flex-col justify-between hidden md:flex">
        <div>
          {/* Logo */}
      ...
      {/* Main Content */}
      <main className="flex-1 px-4 sm:px-9 py-8 overflow-hidden">
        {/* Topbar */}
