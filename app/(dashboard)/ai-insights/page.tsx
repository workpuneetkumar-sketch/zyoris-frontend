...
export default function AiInsightsLandingPage() {
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto px-4 py-6 text-gray-900 relative min-h-screen font-sans bg-white">
      {/* Background Glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[500px] bg-blue-100/70 blur-[120px] rounded-full pointer-events-none" />

      {/* Header */}
      <div className="flex items-center gap-4 relative z-10">
        <div className="w-14 h-14 bg-blue-50 border border-blue-100 rounded-2xl flex items-center justify-center shrink-0 shadow-sm">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Upload business datasets for autonomous profiling, KPIs, forecasting, and RAG chat.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
        ...
        <div className="lg:col-span-1">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="bg-white border border-gray-100 rounded-3xl p-8 flex flex-col items-center justify-center text-center shadow-sm relative overflow-hidden">
            
            <div 
              className="w-full border-2 border-dashed border-blue-200 bg-blue-50/50 rounded-2xl p-8 flex flex-col items-center justify-center hover:bg-blue-50 transition cursor-pointer group"
            ...
            >
              ...
              <div className="w-16 h-16 bg-white border border-blue-100 shadow-sm rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                <UploadCloud size={32} className="text-blue-600" />
              </div>
              <h3 className="text-lg font-bold text-gray-900">New Analysis Session</h3>
            ...
            {status === "UPLOADING" && (
              <div className="mt-6 flex flex-col items-center w-full space-y-3">
                ...
                <p className="text-sm font-semibold text-gray-600 animate-pulse">Uploading and Initializing AI...</p>
              </div>
            )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {sessions.map(session => (
                  <div 
                    ...
                    className="group relative p-5 bg-white border border-gray-100 rounded-2xl hover:border-blue-200 hover:bg-blue-50/50 hover:shadow-md transition-all cursor-pointer overflow-hidden"
                  >
                    ...
                    <div className="flex justify-between items-start mb-3 relative z-10">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-sm text-gray-900 truncate max-w-[180px]">{session.filename}</span>
                      </div>
                      <button 
                    ...
                    <div className="flex items-center justify-between relative z-10">
                      <div className="px-2 py-1 bg-gray-50 rounded-md text-[10px] font-bold border border-gray-200 uppercase tracking-wider">
                      ...
                      {session.dataset?.qualityScore !== undefined && (
                        <div className="text-[10px] text-gray-500 font-medium">
                          Quality: <span className="font-bold text-gray-900">{Math.round(session.dataset.qualityScore)}%</span>
                        </div>
                      )}
                    </div>
                  </div>
