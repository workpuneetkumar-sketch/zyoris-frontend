...
export default function AdminLoginStep2({ onBack, onNext, password, setPassword, isLoading }: AdminLoginStep2Props) {
  return (
    <div className="flex flex-col w-full max-w-md mx-auto bg-white rounded-2xl shadow-2xl shadow-blue-900/10 p-5 sm:p-8 md:p-10 border border-gray-100">
      ...
      <form className="flex flex-col gap-6 mt-6" onSubmit={(e) => { e.preventDefault(); if (password) onNext(); }}>
        ...
        <PrimaryButton type="submit" className="mt-2" disabled={!password || isLoading}>
